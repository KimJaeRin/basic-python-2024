...
class WinApp(QWidget):
    ...
    def btnLoadClicked(self):
        ...
        imagePath = image[0]
        #print(imagePath)   
        pixmap = QPixmap(imagePath).scaledToHeight(381) #파일 경로에 있는 이미지를 읽어서 pixmap객체에 불러드림 
    ...
    def mouseMoveEvent(self, e ) -> None:
        ...
        brush.setPen(QPen(self.brushColor, 3, Qt.SolidLine, Qt.RoundCap ))
        brush.drawPoint(e.x()-10,e.y()-10)
        brush.end()
        self.update()  #화면 업데이트
